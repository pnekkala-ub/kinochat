...
movie_title = st.text_input("Movie Name", placeholder="Enter movie name", key="movie_title", help="Enter the title of the movie as accurately as you can")
if not movie_title:
    st.stop()
...
if st.session_state.movie_title:
    ...
    st.number_input("picks",min_value=1, max_value=10, value=None, key="number_widget", on_change=on_disambiguation_choice_submit, placeholder="Pick a number", help="Choose a number corresponding to the desired movie title")
